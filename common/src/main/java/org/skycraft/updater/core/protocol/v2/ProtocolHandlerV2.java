package org.skycraft.updater.core.protocol.v2;
...
public final class ProtocolHandlerV2 extends ProtocolHandler {
	...
	public ProtocolHandlerV2() {
		super(Protocol.V2, "v2");
	}
		...
		try (JsonWriter writer = new JsonWriter(out)) {
			...
			while (reader.hasNext()) {
				...
				while (reader.hasNext()) {
					...
					case "ignore-client":
						reader.beginArray();
						writer.name("ignore-client").beginArray();
						while (reader.hasNext()) {
							String ignore = reader.nextString();
